...
function updateConfigParametersFromEnv(currentConfig: OrangebeardParameters): OrangebeardParameters {
    ...
    currentConfig.attributes = process.env.ORANGEBEARD_ENDPOINT ? getAttributesFromString(process.env.ORANGEBEARD_ENDPOINT) : currentConfig.attributes;
