...
class OrangebeardClient {
  /**
   * Create a client for Orangebeard.
  ...
  /**
     ...
     * it would create a new Launch instance at Orangebeard with it ID.
     ...
     * Notice that Launch which ID has been sent must be 'IN PROGRESS' state at Orangebeard
  ...
  /*
   * This method is used to create data object for merge request to Orangebeard.
   *
   * @Returns {Object} - an object which contains a data for merge launches in Orangebeard.
   */
  ...
  /*
   * This method is used for merge launches in Orangebeard.
   *
  ...
  getRequestLogWithFile(saveLogRQ, fileObj) {
    const saveLogRequest = saveLogRQ;
    const url = 'log';

    saveLogRequest.file = { name: fileObj.name };
    return this.restClient
      .create(url, this.buildMultiPartStream([saveLogRequest], fileObj, MULTIPART_BOUNDARY), {
...
module.exports = OrangebeardClient;
